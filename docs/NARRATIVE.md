...
### N00 — arrivée, avant P00 (20–30 s, trois cartes touchables)
...
### N01 — après P01 (10–15 s)

Le panorama replace les trois lieux. Petite animation de linge, pas d'inondation spectaculaire.

- [n01_nelle] « L'atelier, l'école, le quai haut. Je les avais oubliés si proches. »
- [n01_jo] « Les enfants sont tous sortis. C'est le chemin qu'ils ont pris qui manque au dossier. »

Objectif : « Remettre les cinq photographies dans l'ordre. »

### N02 — après P02 (15–20 s)
...
### N04 — après P04 seulement

L'ombre reconstruite reste superposée au détail du cliché ; les quatre appuis et trois travées coïncident.

- [n04_nelle] « Ce n'est pas un toit qui s'effondre. Les appuis sont réguliers. On avait construit quelque chose pour passer. »

Si P03 non résolu : objectif « Retrouver les chemins de service ». Sinon aller N05.

### N05 — jonction P03/P04, jouée une seule fois (15 s)

- [n05_jo] « Cette barge faisait partie du matériel d'exercice. Chaque charge a encore son étiquette. »
- [n05_nelle] « Elle devait arriver sans mettre sa cargaison à l'eau. Voyons ce qu'elle portait. »

Transition joueur vers P05. La pluie extérieure décroît. Aucun ajout de preuve utile caché dans l'audio.
...
Le feuillet central se déplie. Trois origines, trois refuges, un emplacement de passerelle non relié.
...
### N08 — pendant P07A, au retrait du plancher (8–12 s)

La maquette de l'atelier s'abaisse avec douceur ; dessous, les trois travées apparaissent. Pas de cri, punition, menace ou destruction définitive. Bouton Annuler disponible.

- [n08_nelle] « Elle ne l'a pas abandonné. Elle lui a donné une autre place. »

### N09 — P07B validé (25 s max)

Six vues papier : livraison à l'atelier ; escalier relevé ; plancher descendu sur barge ; étais en place ; silhouettes traversant ; barge détachée. Le joueur peut passer à l'image suivante et revoir depuis le carnet.
...
[evidence_cartel_final] « Pendant la crue, Aline a démonté le plancher de son atelier pour établir une passerelle entre le clocher et le quai haut. Les photographies, la maquette et son témoignage documentent ce passage. L'école a été évacuée. L'atelier n'a pas été reconstruit. »

### N11 — appel et épilogue (30 s max)

Nelle pose la photo du ponton à côté du téléphone fixe. Pas d'interface de messagerie.

- [n11_nelle] « Maman ? J'ai compris le plancher. »
- [n11_aline] « Il était fait pour porter du monde. »
- [n11_nelle_2] « Viens voir. Cette fois, on a laissé le passage ouvert. »

Fondu court « Quelques semaines plus tard ». Exposition : Aline et Nelle vues de dos en silhouettes papier. Un enfant visiteur suit le tracé du doigt. La maquette porte le nouveau cartel. Aucun dialogue supplémentaire.

[ending_title] « Les Rives pliées »
[ending_line] « Ce que l'on transforme peut aussi rester. »
Boutons : « Explorer la maquette », « Générique », « Accueil ».

## Pièces à conviction et contenus visibles
...
- P06 mène le groupe de l'école au clocher. P07 ajoute le tronçon clocher→quai ; ne pas montrer le groupe déjà au quai après P06.
- Le plan schématique peut simplifier la position des bâtiments, mais leurs pictogrammes, noms, fenêtres et enseignes restent constants.
- Le geste de largage de P07 arrive après tous les passages. La barge et les étais restent l'appui jusqu'alors.
- Nelle ne publie aucun document réel : la correction du cartel est une action fictionnelle locale.
