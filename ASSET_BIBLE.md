...
> **Référence validée :** le producteur a validé le [vertical slice P13](docs/VERTICAL_SLICE.md) et autorisé la production finale. Sa DA s'applique désormais à toute la campagne : réalisme pictural nocturne, bois bleu nuit, laiton patiné, papier ivoire, éclairage ambré. Les prescriptions de géométrie et de lisibilité ci-dessous restent obligatoires. Les anciennes indications « bois clair / ciel gris » sont remplacées par cette référence.

Les assets finaux P13 existent ; le reste est en production, pas encore déclaré terminé. Suivi réel : [FINAL_PRODUCTION](docs/FINAL_PRODUCTION.md). Les planches de design restent des schémas fonctionnels. Les règles et identifiants du manifeste historique sont conservés.
